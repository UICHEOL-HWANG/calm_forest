// =============================================================
//  앱 아이콘 생성 — assets/brand/icon.svg → assets/brand/icon-600.png
...
const TMP_HTML = resolve('assets/brand/_render.html');
...
try {
  execFileSync(CHROME, [
    ...
    '--screenshot=assets/brand/icon-600.png', 'file://' + TMP_HTML,
  ], { stdio: 'ignore' });
  console.log('[make-icon] assets/brand/icon-600.png 생성 완료 (600×600)');
} finally {
