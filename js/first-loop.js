...
export const DEV_PARAMS = ['house', 'coop', 'weather', 'spawn', 'sea', 'river', 'mist', 'time', 'severe', 'severe2', 'rain', 'dbg', 'seadebug', 'give', 'betaDay', 'forceMapOrder', 'owl', 'repeat', 'farmstage', 'farmmax'];
