...
export {
  ...
  isNight, keys, kitchenFinish, kitchenStart, lastDoorPrompt, lastFloorChoiceKey, lastNearHouse, lastNearMiss,
  lastZoneHint, makeCharacterPreview, makeNameTag, makeSignBoard, makeSignpost, mapLocked, markHabitatDirty,
  measureStowLen, mergeGeos, mgView, mineGroup, mineTorches, mist, mistGroup, mistLanterns, mistTree, museumGroup,
  nearBench, nearBoat, nearBoatShop, nearCafeBoard, nearCafeGuest, nearCoop, nearCosShop, nearDecorMesh,
  nearDoor, nearDoorFloor, nearForest, nearGlade, nearKitchen, nearMarket, nearNPC, nearOutdoorMesh, nearRank,
  nearShop, nearStation, nightFetcher, nightLevel, nightNoteFetcher, noteSpecialExhibit, npcObjs, obstacles,
  onPlotArea, oreRocks, outdoorMesh, outdoorMeshes, outdoorTarget, paintGeo, pantryHas, pantryTake, pendingDish,
  pestTarget, pestTexture, petChoresNear, petJob, pickedDecor, pickedOutdoor, placeOutdoor, placingDecor,
  ...
  setFogExempt, setHeldDecor, setHeldTool, setSpaceVisible, settleDifficulty, settleOrchard, severeOf, shared,
  showCatchItem, sitting, situation, snapCamera, solidBox, solidCircle, spawnConfetti, spawnDust, spawnFloatText,
  spawnLeafBurst, spawnSparkle, spawnSplash, spawnTree, spawnWater, spawnWoodChips, stopOutdoorPlacing, swayables,
  syncBadges, syncFarmHints, syncStory, todayStr, toolMesh, toolPage, trackGateBlocked, trees, triggerFarmReveal,
  triggerMoment, tryUnlockDrop, ui, updateCarveScene, updatePlotVisual, updateStowPose, updateToolPageAuto,
  usePet, vtxMat, wantAction, warnTexture, weedTexture, wiltPlot, woodMat, workerCap, worldGround, worldGroundPatches,
};
