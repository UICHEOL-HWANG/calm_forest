...
export {
  ...
  outdoorMeshes, outdoorTarget, paintGeo, pantryHas, pantryTake, particles, pendingDig, pendingDish, pestTarget,
  pestTexture, pet3d, petChoresNear, petJob, pickedDecor, pickedOutdoor, placeOutdoor, placingDecor, placingOutdoor,
  player, playerAnchor, playerArms, playerInYard, plots, pointer, poseHeldTool, priceOf, priceRate, questEvent,
  raycaster, rebuildInteriorFinish, rebuildOrchard, refreshCollectQuests, refreshCropStage, refreshHeldTool,
  ...
  seaRodMesh, seedHintTexture, setFogExempt, setHeldDecor, setHeldTool, setPlotHarvest, setPlotSeedHint,
  setPlotWarn, setSpaceVisible, settleDifficulty, settleOrchard, severeOf, shared, showCatchItem, sitting,
