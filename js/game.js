...
export {
  ...
  clearPest, clock, colliders, cookTier, cosmeticShop, cropMini, currentTool, dateHash, decorGhost, decorMeshes,
  decorNearRing, decorRot, decorTapHintShown, decorTarget, dexDiscover, diffParams, disposeTree, dist2D,
  doPlayerAction, dockGroup, easeOutBack, farmActionFirst, farmBuildingRecs, farmGroup, farmHalf, fertTarget,
  finishPetJob, firstHint, firstHintBanner, fishMesh, forageNodes, forecastLine, forestGroup, gambrelRoofSlabs,
  gambrelSolid, gameState, ghostOutdoor, giveReward, gladeBugs, gladeGroup, habitatCells, habitatCtx, habitatEnvAt,
  handAnchor, heldGroup, heldToolMesh, houseCollider, houseFloor, houseGhost, houseGroup, houseSign, houseSignCtx,
  houseSignTex, houseWindows, indoor, interiorFloor, interiorFloors, interiorGroup, interiorLamp, isNight,
  keys, kitchenFinish, kitchenStart, lastDoorPrompt, lastFloorChoiceKey, lastNearHouse, lastNearMiss, lastZoneHint,
  makeCharacterPreview, makeNameTag, makeSignBoard, makeSignpost, mapLocked, markHabitatDirty, measureStowLen,
  mergeGeos, mgView, mineGroup, mineTorches, mist, mistGroup, mistLanterns, mistTree, museumGroup, nearBench,
  nearBoat, nearBoatShop, nearCafeBoard, nearCafeGuest, nearCoop, nearCosShop, nearDecorMesh, nearDoor, nearDoorFloor,
  nearForest, nearGlade, nearKitchen, nearMarket, nearNPC, nearOutdoorMesh, nearRank, nearShop, nearStation,
  nightLevel, noteSpecialExhibit, obstacles, oreRocks, outdoorMesh, outdoorMeshes, outdoorTarget, paintGeo,
  pantryHas, pantryTake, pendingDish, pestTarget, petChoresNear, petJob, pickedDecor, pickedOutdoor, placeOutdoor,
  placingDecor, placingOutdoor, player, playerAnchor, playerArms, playerInYard, plots, pointer, poseHeldTool,
  ...
  todayStr, toolMesh, toolPage, trackGateBlocked, trees, triggerFarmReveal, triggerMoment, tryUnlockDrop,
  ui, updateCarveScene, updateStowPose, updateToolPageAuto, usePet, vtxMat, wantAction, woodMat, workerCap,
};
