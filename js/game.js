...
export {
  ...
  seaFishes, seaGroup, seaLine, seaMG, seaRodMesh, setFogExempt, setHeldDecor, setHeldTool, setSpaceVisible,
  ...
  syncBadges, syncStory, todayStr, toolMesh, trackGateBlocked, trees, triggerFarmReveal, triggerMoment, tryUnlockDrop,
  ui, updateCarveScene, updateStowPose, usePet, vtxMat, wantAction, woodMat,
};
