...
export {
  ...
  farmHalf, finishPetJob, firstHint, fishMesh, forageNodes, forestGroup, gameState, ghostOutdoor, giveReward,
  gladeBugs, gladeGroup, habitatCtx, habitatEnvAt, handAnchor, heldGroup, heldToolMesh, houseCollider, houseFloor,
  ...
  lastZoneHint, makeCharacterPreview, makeNameTag, makeSignBoard, makeSignpost, mapLocked, measureStowLen,
  mergeGeos, mgView, mist, mistGroup, mistLanterns, mistTree, museumGroup, nearBoat, nearBoatShop, nearCafeBoard,
  nearCafeGuest, nearDoor, nearStation, nightLevel, noteSpecialExhibit, obstacles, outdoorMesh, outdoorMeshes,
  outdoorTarget, pantryHas, pantryTake, pendingDish, pestTarget, petJob, pickedDecor, pickedOutdoor, placeOutdoor,
  placingDecor, placingOutdoor, player, playerAnchor, playerArms, plots, pointer, poseHeldTool, questEvent,
  raycaster, rebuildInteriorFinish, refreshCollectQuests, refreshInventoryUI, refreshStations, removeSolid,
  renderer, respawnPet, riverActive, riverCourse, riverGroup, riverPool, rollDifficulty, roundRect, scene,
  seaBuoy, seaFishes, seaGroup, seaLine, seaMG, seaRodMesh, setFogExempt, setHeldDecor, setHeldTool, setSpaceVisible,
  settleDifficulty, settleOrchard, shared, showCatchItem, situation, snapCamera, solidBox, solidCircle, spawnConfetti,
  spawnDust, spawnFloatText, spawnSparkle, spawnSplash, spawnTree, swayables, syncBadges, syncStory, todayStr,
  toolMesh, trackGateBlocked, trees, triggerMoment, tryUnlockDrop, ui, updateCarveScene, updateStowPose,
