...
export {
  ...
  dockGroup, easeOutBack, farmBuildingRecs, farmHalf, finishPetJob, firstHint, fishMesh, forageNodes, forecastLine,
  ...
  makeSignpost, mapLocked, markHabitatDirty, measureStowLen, mergeGeos, mgView, mist, mistGroup, mistLanterns,
  mistTree, museumGroup, nearBoat, nearBoatShop, nearCafeBoard, nearCafeGuest, nearDoor, nearNPC, nearStation,
  nightLevel, noteSpecialExhibit, obstacles, outdoorMesh, outdoorMeshes, outdoorTarget, pantryHas, pantryTake,
  pendingDish, pestTarget, petJob, pickedDecor, pickedOutdoor, placeOutdoor, placingDecor, placingOutdoor,
  player, playerAnchor, playerArms, plots, pointer, poseHeldTool, priceOf, priceRate, questEvent, raycaster,
  rebuildInteriorFinish, refreshCollectQuests, refreshHeldTool, refreshInventoryUI, refreshStations, removeSolid,
  renderer, respawnPet, rewardText, riverActive, riverCourse, riverGroup, riverPool, rollDifficulty, roundRect,
  scene, seaBuoy, seaFishes, seaGroup, seaLine, seaMG, seaRodMesh, setFogExempt, setHeldDecor, setHeldTool,
  setSpaceVisible, settleDifficulty, settleOrchard, shared, showCatchItem, sitting, situation, snapCamera,
  solidBox, solidCircle, spawnConfetti, spawnDust, spawnFloatText, spawnSparkle, spawnSplash, spawnTree,
  stopOutdoorPlacing, swayables, syncBadges, syncStory, todayStr, toolMesh, trackGateBlocked, trees, triggerMoment,
  tryUnlockDrop, ui, updateCarveScene, updateStowPose, usePet, wantAction, woodMat,
};
