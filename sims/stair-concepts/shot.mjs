...
//   예) node shot.mjs stage4.png "stair=4&cam=close"   ·  node shot.mjs all.png "all=1&cam=line" 1600 720
...
const [,, out, query = 'stair=4', W = '1280', H = '720'] = process.argv;
const url = `http://localhost:8000/sims/stair-concepts/?${query}`;
