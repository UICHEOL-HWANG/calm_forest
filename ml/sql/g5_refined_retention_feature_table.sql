-- G5 refined retention feature table, NOT an A/B read.
...
-- Feature window: [first_ts, +10m). Label window: [+10m, +24h).
-- Output is one anonymous device row. Raw GA4 device IDs stay inside the query.
WITH actions AS (
