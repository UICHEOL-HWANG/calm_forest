...
- **🔧 도구** — 강철 도끼(2번 벌목)·큰 물조리개·튼튼한 낚싯대 (영구 업그레이드)
- **🌷 야외** — 울타리·디딤돌·꽃밭·정원등을 마당 원하는 곳에 설치
- **🎁 선물** — 주민에게 줄 선물 제작

## 🛒 상점 · 🪙 코인

상점 좌판에서 **작물·물고기·목재를 팔아 코인**을 벌고(탭=1개, 꾹=전부), **씨앗 등을 구매**. 코인 경제가 다른 시스템의 화폐 기반이 됩니다.
...
첫 로그인 시 이동→벌목→밭갈기→씨앗→물주기→수확→주민 퀘스트→낚시→집짓기→입장→꾸미기 **11단계 인터랙티브 코치**가 안내(1회). 좌측 상단 **❓** 버튼으로 다시 볼 수 있어요.
